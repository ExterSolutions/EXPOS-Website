...
export const SiteDataProvider = ({ children }) => {
    const [siteData, setSiteData] = useState({
        site_name: "Panjab Pizza",
        logo: null,
        contact_email: "sales@panjabpizza.ca",
    ...
    const fetchSiteData = async () => {
        try {
            ...
            if (response.status && response.data) {
                setSiteData({
                    site_name: response.data.site_name || "Panjab Pizza",
                    logo: response.data.logo || null,
                    contact_email: response.data.contact_email || "sales@panjabpizza.ca",
