...
//                                         <img src="src/assets/images/logo.png" alt="Logo" className="img-fluid" style={{ maxWidth: '100px' }} />
//                                     </div>
...
//                                     </div>
//                                     <h2 className="card-title text-danger">Payment Verification Failed</h2>
//                                     <p className="card-text">
