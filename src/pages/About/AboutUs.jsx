                ...
                <div className="czcustomcms">
                    ...
                    <div className="one-half custombanner-part2">
                        <div className="custombanner-content">
                            ...
                            <div className="main-title">Panjab Pizza</div>
                            <div className="cms-desc">At Panjab Pizza, we craft unforgettable vegetarian pizzas that fuse the rich flavors of Punjab with classic Italian style, creating a deliciously sustainable dining experience for food lovers everywhere..
                            </div>
                            <div className="cms-desc">
                                Panjab Pizza brings authentic Punjabi-style vegetarian pizzas to Calgary NE. Whether you're searching for "pizza near me" or craving our signature Amritsari Pizza, we’ve got you covered. Visit us at 5 Coral Springs Blvd NE or order online for pickup or delivery!
                            </div>
                        </div>
