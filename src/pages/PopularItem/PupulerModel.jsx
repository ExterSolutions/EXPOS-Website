...
import "./PopulerModel.css";

function PupulerModel({
    show,
    handleClose,
    data,
    ing,
    ...
    return (
        ...
        >
            ...
            >
                <Container className="overflow-y-auto max-w card-background-color card-text-color px-3 py-3 square-container">
                    <Row>
                        <Col xs={12}>
            ...
            <Modal.Footer className="primary-background-color primary-text-color">
                <Button
                    className="tps_cart_btn square-button"
