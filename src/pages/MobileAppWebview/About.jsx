                            ...
                            <div className="col-custom2 pd0 card-background-color">
                                ...
                                <div className="block-stl12 ">
                                    ...
                                    <p className="fst-italic lh-base infoText card-text-color">
                                        ...
                                        At Panjab pizza, we’re passionate about crafting delicious, 100% vegetarian pizzas that bring together bold, flavorful ingredients to create a truly satisfying experience. Every pizza is made with care, blending tradition with creativity to please every palate.
                                    </p>
                                    <br />
                                    <br />
                                    <p className="fst-italic lh-base infoText card-text-color">
                                                    ...
                                                    <div class="img-holder p-1 fst-italic">
                                                        <p className="commitText lh-base">
                                                            ...
                                                            <span className="card-text-color  ">
                                                                ...
                                                                Panjab pizza. We source the fresh produce,
