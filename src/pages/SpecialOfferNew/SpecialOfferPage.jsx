...
const SpecialOfferPage = () => {
        ...
        try {
            ...
            const systemsettings = {
                ...
                premiumTopppingLabel:
                    settingsData.find((s) => s.settingCode === "STG_5")
                        ?.settingValue ?? "Premium Toppings",
                regularToppingLabel:
                    settingsData.find((s) => s.settingCode === "STG_6")
    ...
    const handleSelectSignaturePizza = (pizzaIndex, pizzaObj) => {
        ...
        setPizzaSelections((prev) => {
            ...
            updated[pizzaIndex] = {
                ...
                crustType: findDefault(
                    offerData.crustType,
                    pizzaObj.defaultCrustType,
                ),
    ...
    const handleAddToCart = (e) => {
        ...
        if (currentStoreCode === undefined || currentStoreCode === null) {
            ...
            toast.error(
                "Please select a store to start adding items to the cart..",
                {
                    position: "top-center",
                    autoClose: 3000,
                },
        ...
        const hasMissingSignature = pizzaSelections.some(
            (pizza) =>
                !pizza.signaturePizzaCode ||
                pizza.signaturePizzaCode.trim() === "",
        );
            ...
            <div className="container py-4">
                <div className="row">
                    ...
                    <div className="col-lg-6 col-12">
                        <h5 className="fw-bold d-none d-md-block mb-3">
                            {offerData.name}
                        </h5>
