...
function SignatureViewSelectionModal({
    viewSelection,
    setViewSelection,
    Ingredients,
    size,
                        ...
                        <div className="scrollable-content" >
                            {size && <div className="pizza-card-border-color py-3">
                                <div className="row">
                                    ...
                                    <div className="col-lg-6" >
                                        {Crust && <p className="lh-sm fs-6 mt-2 mt-lg-0"><GoDotFill /> Dough: {Ingredients?.crust?.filter((top) => top?.crustCode === Crust)[0]?.crustName} (${Ingredients?.crust?.filter((top) => top?.crustCode === Crust)[0]?.price})</p>}
...
export default SignatureViewSelectionModal