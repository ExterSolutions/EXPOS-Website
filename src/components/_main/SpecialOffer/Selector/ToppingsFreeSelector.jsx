...
function ToppingsFreeSelector({ data, ToppingsFree, handleTopping, handleSizeChange }) {
    ...
    const isSelected = ToppingsFree?.some(obj => obj?.toppingsCode === data?.toppingsCode);
        ...
        <div className={`topping-item ${isSelected ? 'active' : ''}`}
            ...
            <div className="d-flex justify-content-between align-items-start">
                <div className="d-flex align-items-center">
                    ...
                    <span className="topping-item-name">
                        {data?.toppingsName} {data?.price > 0 ? `($${data.price})` : ''}
                    </span>
                </div>
            ...
            <div className="mt-2 pl-4 ml-4">
                <select
                    ...
                    value={ToppingsFree?.find((el) => el?.toppingsCode === data?.toppingsCode)?.toppingsPlacement || pizzaSize}
