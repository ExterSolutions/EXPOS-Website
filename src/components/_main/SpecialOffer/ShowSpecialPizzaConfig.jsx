        ...
        <>
            ...
            {pizzaState[count] && (
                <div className="px-3 py-1">
                    <div className="d-flex flex-column gap-1 mb-2 cart-selection-summary text-secondary" style={{ fontSize: '0.9rem' }}>
                        <p className="mb-1 text-dark fw-bold">Pizza : {pizzaState[count]?.signaturePizza?.pizzaName || "Not Selected"}</p>

                        {pizzaState[count]?.cheese?.cheeseName && <p className="mb-0">Cheese: <span className="text-dark">{pizzaState[count].cheese.cheeseName}</span></p>}
