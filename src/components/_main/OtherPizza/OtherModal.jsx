...
function OtherModel({
    ...
    const handleAddToCart = () => {
        ...
        let toppingOneArray = toppingsOneData?.map((el) => {
            let matchedToppingOne = data?.topping_as_2?.find(
                (topping) => topping?.code === el?.toppingsCode
            );
            return {
                toppingsCode: el?.toppingsCode,
        ...
        let toppingFreeArray = toppingsFreeData?.map((el) => {
            let matchedToppingFree = data?.topping_as_2?.find(
                (topping) => topping?.code === el?.toppingsCode
            );
            return {
                toppingsCode: el?.toppingsCode,
    ...
    return (
        ...
        >
            ...
            <Modal.Footer>
                <button type="button" className="view-button" onClick={handleAddToCart}>
                    Add to Cart
                </button>
            </Modal.Footer>
        </Modal>
