...
const Footer = ({ isdemo }) => {
    ...
    const footerNote = footerData?.footer_note ||
        "At Panjab Pizza, we craft delicious, handmade pizzas with the freshest ingredients to bring you a slice of happiness in every bite.";
                    ...
                    <div className="col-12 col-md-5 sm-center mb-3">
                        <div className="logo">
                            <Link to={"/"}>
                                <img
                                    src={logoSrc}
                                    alt="Panjab Pizza Official Logo"
                                    className="img-fluid"
                                    style={{ width: "72px" }}
                                />
                            </Link>
                        ...
                        <p className="my-3 lh-sm">
                            <span className="main fw-bold">Panjab Pizza</span><br /><br />
                            {footerNote.includes("Panjab Pizza")
                                ? footerNote.replace("Panjab Pizza", "").trim()
                                : ` ${footerNote}`
                            }
                        </p>
                        ...
                        <div className="py-3 d-flex flex-column gap-3 w-100">
                            <div className="d-flex justify-content-start  align-items-center gap-1">
                                <Link
                                    to="mailto:sales@panjabpizza.ca?subject=Contact"
                                ...
                                >
                                    ...
                                    <span>sales@panjabpizza.ca</span>
                                </Link>
                            </div>
                            <div
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span className="">+1 403 492 5500</span>
                                </Link>
                            </div>
                        </div>
                    </div>
